...
class HomeConsumer extends ConsumerWidget {
  HomeConsumer({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return _ui(context, ref);
  }

  _ui(BuildContext context, WidgetRef ref) {
    ...
    return ref.watch(chartFutureProvider).when(
          data: (data) {
            int widowsCount = data.data.widowsCount.count;
            int lgaCount = data.data.lgaCount;
            List<BaseLocalGovtData> employmentStaList =
                data.data.employmentStatusData.data;
            List<BaseLocalGovtData> affiliationToNGOList =
                data.data.nGOAffiliation.data;
              ...
              children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FutureBuilder(
                                  future: compute(
                                    computeLga,
                                    data.data.localGovData.data,
                                  ),
                                  builder:
                                      (_, AsyncSnapshot<dynamic> snapshot) {
                                    if (snapshot.hasData) {
                ...
                FutureBuilder(
                  future: compute(
                    ...
                    data.data.yearsInMarriageData.data,
                  ),
                  builder: (_, AsyncSnapshot<dynamic> snapshot) {
                    if (snapshot.hasData) {
                      List<int> value =
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CustomBarChart(
                                        ...
                                        smallWidth: 18,
                                        largeWidth: 18 + 10,
                                        map: data.data.occupationData.data,
                                        groupsSpace: 10,
                                        gridData: FlGridData(
                                          show: false,
                                          drawVerticalLine: false,
    ...
    onTick: (controller, elapsed, size) {
      ...
      for (int i = particles.length - 1; i >= 0; i--) {
        ...
        particle.update(
          ...
          // advance the sprite-sheet frame:
